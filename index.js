...
const zooAnimals = [
  ...
  */
  ...
  function lowerCaseNames(array){
    const updatedNames = array.map(item => item.animal_name.toLowerCase());
    return updatedNames;
  }
  ...
  */
  ...
  function lowPopulationAnimals(array){
    const smallPops = array.filter(item => item.population < 5);
    return smallPops;
  }
  ...
  */
  ...
  function USApop(array){
    const totalAnimalPops = array.reduce((acc, item) => acc + item.population, 0);
    return totalAnimalPops;
  }
